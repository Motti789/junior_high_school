...
course1 = Course.create(subject: "English Language", teacher_id: "1", student_id: "1")
course2 = Course.create(subject: "Mathematics", teacher_id: "3", student_id: "2")
course3 = Course.create(subject: "Science", teacher_id: "2", student_id: "3")
course4 = Course.create(subject: "History", teacher_id: "1", student_id: "3")
course5 = Course.create(subject: "Foreign Languages", teacher_id: "3", student_id: "1")
